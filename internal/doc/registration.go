...
func registerUserOperation() *Operation {
	...
	successSchema.AddProperty("id", "integer", "Generated id of the user", false)
	successSchema.AddProperty("firstName", "string", "The first name of the user", false)
	successSchema.AddProperty("lastName", "string", "The last name of the user", false)
	successSchema.AddProperty("email", "string", "The email of the user", false)
	successSchema.AddProperty("activated", "boolean", "Indicates whether the user has been activated via email verification", false)
